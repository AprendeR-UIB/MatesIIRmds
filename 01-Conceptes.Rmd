...
```{example,sampleUIB}
La UIB té uns 12000 estudiants. Suposem que aquest nombre és exacte i que els tenim numerats de l'1 al 12000. Aleshores, podríem treure'n una mostra aleatòria simple de mida 20 amb
