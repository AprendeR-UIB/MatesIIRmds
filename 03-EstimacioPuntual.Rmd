...
Per tant, només un 1.5\% de les mostres aleatòries simples de `r n-1` recent nats tenen una desviació típica mostral més petita o igual que la de la nostra mostra de recent nats amb SIDA. 
