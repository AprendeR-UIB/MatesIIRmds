...
$$
Al nostre cas coincideix amb el que hem calculat perquè la variable $S_{10}\sim B(10,0.5)$ és simètrica, però si no ho fos no té per què coincidir. Comprovem que, en efecte, en aquest exemple coincideixen:
