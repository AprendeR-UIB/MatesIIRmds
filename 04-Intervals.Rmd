...
*Tenir una confiança del Q%* significa doncs que l'hem calculat amb una fórmula **que encerta el Q% de les vegades**, en el sentit que en Q de cada 100 vegades que aplicàssim aquesta fórmula a mostres aleatòries simples, els intervals que obtendríem contendrien el valor real del paràmetre que volem estimar. Però **un (100-Q)% de les vegades s'equivoca**, és a dir, (100-Q) de cada 100 intervals obtinguts aplicant  aquesta fórmula a mostres aleatòries simples  **no** contenen el valor real del paràmetre que volem estimar. *I no sabem quin és el nostre cas*.
