...
Tenim $k$ variables aleatòries Bernoulli  $X_1,\ldots,X_k$, de probabilitats poblacionals $p_1,\ldots,p_k$. 
...
```{r}
> TaulaC=matrix(c(43,61,53,57,39,47), 
nrow=2,byrow=TRUE)
> TaulaC
[,1] [,2] [,3]
[1,] 43 61 53
...
```{r}
> TaulaC2=matrix(c(12,21,13,31,40,40,57,39,
47), nrow=3, byrow=TRUE)
> TaulaC2
[,1] [,2] [,3]
[1,] 12 21 13
[2,] 31 40 40
