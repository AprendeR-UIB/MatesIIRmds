...
Per utilitzar-lo, basta que la mostra total sigui gran ($\geq 30$), no cal la condició de Cochran. (Si teniu curiositat sobre com es fa, podeu consultar [la seva entrada de la Wikipedia](https://en.wikipedia.org/wiki/Cochran–Armitage_test_for_trend))
...
> "$p_N\leq p_O  \leq p_R$ i almenys una  d'aquestes desigualtats és estricta" 

és equivalent a dir  

> "$p_N\leq p_O  \leq p_R$ i $p_N<p_R$"
