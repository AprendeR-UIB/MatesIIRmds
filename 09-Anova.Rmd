...
* $\mu_i-\mu$ representa la desviació respecte de la mitjana global $\mu$ de la mitjana de $X$ en el nivell $i$-èssim; en direm l'**efecte del tractament $i$-èssim** i representa la contribució a $X_i$ del fet de pertànyer a aquest nivell 
...
* $\mu_i-\mu$ representa la desviació respecte de la mitjana global $\mu$ de la mitjana de  $X$
  en el nivell $i$-èssim (l'**efecte del tractament $i$-èssim**)

* $\mu_{\bullet j}-\mu$ representa la desviació respecte de la mitjana global $\mu$ de la mitjana de  $X$ en el bloc $j$-èssim (l'**efecte del bloc $j$-èssim**)

* $E_{ij}$  representa la part de la diferència entre  $X_{ij}$ i  $\mu$ que no explica ni el tractament ni el bloc; en diem  l'**error aleatori**, o el **residu**. 
