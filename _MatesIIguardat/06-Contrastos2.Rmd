...
**(4)** En un experiment, a una sèrie de ratolins modificats genèticament se'ls tractà amb un compost per estudiar si, en un període de temps després d'administrar-lo, el nivell d'un cert metabolit en sang havia disminuït. S'accepta que la distribució de la quantitat d'aquest metabolit en sang és normal. Quina és la prova estadística més adient per realitzar el contrast?
...
**(7)** En un experiment, una de les mesures que es va estudiar va ser un cert temps de reacció que és molt asimètric a la dreta. Per contrastar la diferència entre les mitjanes d'aquest temps de reacció sota dues condicions diferents, els enfocaments possibles inclouen (marca totes les respostes correctes):
 
1. Un test t si les dues mostres eren més grans que 100 cada una.
1. Un test t si alguna de les dues mostres era més gran  que 100.
1. Com que es tracta d'un contrast de mitjanes amb mostres independents, podem emprar sempre un test t. 
1. Com que les mesures d'aquest temps de reacció segueixen una llei normal, podem emprar un test t encara que els grups siguin petits. 
...
**(14)** Quines de les afirmacions següents sobre el test F són correctes?
...
**(17)** Quines de les afirmacions següents sobre el test de Wilcoxon d'una mitjana o dues mitjanes són vertaderes?
